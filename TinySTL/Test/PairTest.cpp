...
static inline bool container_equal(const Container1& pair1,
                                   const Container2& pair2)
{
...
void testCase3()
{
    stdPair<std::string> temp1 = std::make_pair(std::string("zxh"),
                                 std::string("zxh"));
    stdPair<std::string> p1 = temp1;

    tsPair<std::string> temp2 = TinySTL::make_pair(std::string("zxh"),
                                std::string("zxh"));
